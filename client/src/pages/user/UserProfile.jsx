    ...
    <div className="app-shell">
      <main className="section-wrap grid min-h-screen place-items-center">
        <section className="panel w-full max-w-2xl">
          <p className="badge mb-4">Employee profile</p>
          <h1 className="text-3xl font-bold text-white">Your profile</h1>
          <p className="mt-2 text-slate-400">Account details connected to your job search.</p>
          ...
          <button onClick={() => navigate("/user")} className="btn-primary mt-8">
            Back to dashboard
          </button>
        </section>
      </main>
