      ...
      <div className="bg-zinc-800 rounded-xl w-full max-w-md p-6 md:p-8 shadow-xl z-10">
        ...
        <form className="flex flex-col gap-3" onSubmit={handlesubmit}>
          ...
          <input
            ...
            onChange={(e) => setusername(e.target.value)}
            required
            className="border border-zinc-500 rounded-md w-full p-2 bg-zinc-900 text-white placeholder-zinc-400"
          />
          ...
          <button
            type="submit"
            className="w-full mt-5 bg-red-700 rounded-md py-2 hover:bg-red-800 duration-100 text-white"
          >
            Register
          </button>
